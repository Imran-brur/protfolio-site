    ...
    return (
        <div className="about text-white">
            ...
            <div className='row'>
                ...
                <div className="col-md-8 ml-5 mt-5 text-secondary">
            ...
            <div class="row ml-5 mt-5 m-4">
                <div class="col-md-6">
                    <div style={{fontSize: '20px', height: '322px'}} class="card bg-secondary p-3">
                    <h2 >PERSONAL INFO</h2>
                ...
                <div class="col-md-6 skill">
                    <div style={{fontSize: '20px'}} class="card bg-secondary p-3">
                        <h2 >SKILL</h2>
            ...
            <div className='text-center mt-5 mr-5'>
                ...
                <button class="btn btn-outline-dark btn-lg">DOWNLOAD RESUME</button>
                </a>          
            </div>
            </div>
        </div>
